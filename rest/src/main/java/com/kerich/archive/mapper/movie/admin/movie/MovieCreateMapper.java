...
public abstract class MovieCreateMapper {
    @Autowired
    ...
    @Mapping(target = "actors", expression = "java(actorService.findActorsByIds(movieCreateDto.actorIds()))")
    @Mapping(target = "countries", expression = "java(countryService.findCountriesByIds(movieCreateDto.countryIds()))")
    @Mapping(target = "directors", expression = "java(directorService.findDirectorsByIds(movieCreateDto.directorIds()))")
    @Mapping(target = "genres", expression = "java(genreService.findGenresByIds(movieCreateDto.genreIds()))")
    @Mapping(target = "themes", expression = "java(themeService.findThemesByIds(movieCreateDto.themeIds()))")
    ...
    public abstract MovieCreateDto toDto(Movie movie);
